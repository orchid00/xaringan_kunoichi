...
1. The **xaringan** package to create R markdown presentations.

1. The **kunoichi** theme to add R-ladies flavour to your presentation.

1. [Rladies theme and fonts](https://alison.rbind.io/post/2017-12-18-r-ladies-presentation-ninja/).
...
```{r echo=FALSE, eval=TRUE}
anicon::faa('github', animate='float', rtext='allisonhors')
```
